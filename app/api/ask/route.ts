  ...
  try {
    ...
    const result = streamText({
      ...
      system: `You are a helpful AI assistant with access to a knowledge base.
            ...
            4. Provide all information that you have about certain incident. For example if user ask about incident provide all detail information including incident number and date of incident.
            `,
    });
